...
import net.mcreator.sirenhead.HunterBow.CapabilityHelper;
import net.mcreator.sirenhead.HunterBow.IRangedWeapon;
import net.mcreator.sirenhead.HunterBow.IWeapon;
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        abstractarrowentity.setDamage(abstractarrowentity.getDamage() + 4 * 0.5D + 0.5D);

                        int j = EnchantmentHelper.getEnchantmentLevel(Enchantments.POWER, stack);
                        if (j > 0) {
                            abstractarrowentity.setDamage(abstractarrowentity.getDamage() + 4 + (double)j * 0.5D + 0.5D);
                        }
